...
public sealed class SpdxExpressionTests
{
    public sealed class TheParseMethod
    {
        ...
        [Theory]
        [InlineData(SpdxLicenseParseOptions.AllowUnknownLicenses)]
        [InlineData(SpdxLicenseParseOptions.Relaxed)]
        public void Should_Not_Return_Error_When_License_Is_Unknown_If_Parsing_Is_Relaxed(SpdxLicenseParseOptions options)
        {
            // Given, When
        ...
        [InlineData(SpdxLicenseParseOptions.AllowUnknownLicenses | SpdxLicenseParseOptions.AllowUnknownExceptions)]
        [InlineData(SpdxLicenseParseOptions.Relaxed)]
        public void Should_Not_Return_Error_If_License_Exception_Is_Unknown_If_Parsing_Is_Relaxed(SpdxLicenseParseOptions options)
        {
            // Given, When
    ...
    public sealed class TheIsValidExpressionMethod
    {
        ...
        {
            // Given, When
            var result = SpdxExpression.IsValidExpression("MIT OR LOL", SpdxLicenseParseOptions.Relaxed);
