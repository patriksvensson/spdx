...
public abstract class SpdxExpression
{
    ...
    {
        return Parse(expression, SpdxLicenseParseOptions.Strict);
    }
    ...
    /// <returns>An abstract syntax tree representing the original expression.</returns>
    public static SpdxExpression Parse(string expression, SpdxLicenseParseOptions options)
    {
    ...
    {
        return TryParse(expression, SpdxLicenseParseOptions.Strict, out result);
    }
    ...
    /// <c>true</c> if <paramref name="expression"/> was parsed successfully; otherwise, <c>false</c>.
    /// </returns>
    public static bool TryParse(string expression, SpdxLicenseParseOptions options, out SpdxExpression? result)
    {
        try
        {
    ...
    /// <c>true</c> if <paramref name="expression"/> was parsed successfully; otherwise, <c>false</c>.
    /// </returns>
    public static bool IsValidExpression(string expression, SpdxLicenseParseOptions options)
    {
